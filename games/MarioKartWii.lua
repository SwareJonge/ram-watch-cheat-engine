...
GV.mtcharge =
  MV("MT Charge", 0x4EA, SMG1.RefValue, ByteType)
GV.checkpoint =
  MV("CheckPoint ID", -0x8B65, SMG1.RefValue, ByteType)
GV.keycheckpoint =
  MV("Key CheckPoint ID", -0x8B49, SMG1.RefValue, ByteType)
-- When this timer is inactive, its value is 180
GV.lapcompleted =
  MV("Lap Completion", -0x8B64, SMG1.RefValue, FloatType)
GV.mtboost =
  MV("MT Boost Timer", 0x4EF, SMG1.RefValue, ByteType)
GV.mushroomboost =
  MV("Mushroom Boost Timer", 0x4FD, SMG1.RefValue, ByteType)
GV.trickboost =
  MV("Trick Boost Timer", 0x501, SMG1.RefValue, ByteType)
