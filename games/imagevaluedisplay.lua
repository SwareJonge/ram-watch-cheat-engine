...
self.d14:loadFromFile(InputDirectory .. '/Right7.png')
  ...
  self.d14:loadFromFile(InputDirectory .. '/Up7.png')
    ...
    local ImageNumberDisplayhorizontalManderMode = subclass(SimpleElement)

    function ImageNumberDisplayhorizontalManderMode:init(window, numberMemoryValue)
      self.numberMemoryValue = numberMemoryValue
    ...
    self.d14:loadFromFile(InputDirectory .. '/Right7.png')
      ...
      function ImageNumberDisplayhorizontalManderMode:update()
        local number = self.numberMemoryValue:get()
        local onesDigit = number % 100
        if onesDigit == 0 then
          self.uiObj.setPicture(self.d0)
      ...
      local ImageNumberDisplayverticalManderMode = subclass(SimpleElement)

      function ImageNumberDisplayverticalManderMode:init(window, numberMemoryValue)
        self.numberMemoryValue = numberMemoryValue
      ...
      self.d14:loadFromFile(InputDirectory .. '/Up7.png')
        ...
        function ImageNumberDisplayverticalManderMode:update()
          local number = self.numberMemoryValue:get()
          local onesDigit = number % 100
          if onesDigit == 0 then
            self.uiObj.setPicture(self.d0)
  ...
  local ImageNumberDisplayABLRManderMode = subclass(SimpleElement)

  function ImageNumberDisplayABLRManderMode:init(window, numberMemoryValue)
    self.numberMemoryValue = numberMemoryValue
  ...
  function ImageNumberDisplayABLRManderMode:update()
   local number = self.numberMemoryValue:get()
   local onesDigit = number % 1000
      if onesDigit == 0 then
        self.uiObj.setPicture(self.d0)
  ...
  ImageNumberDisplayhorizontalManderMode = ImageNumberDisplayhorizontalManderMode,
  ImageNumberDisplayverticalManderMode = ImageNumberDisplayverticalManderMode,
  ImageNumberDisplayDPAD = ImageNumberDisplayDPAD,
  ImageNumberDisplayABLRManderMode = ImageNumberDisplayABLRManderMode,
